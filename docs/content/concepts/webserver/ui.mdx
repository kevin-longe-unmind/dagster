...
<!-- ![The Catalog views dropdown in the Dagster UI](/images/concepts/webserver/catalog-views.png) -->

<Image
alt="The Catalog views dropdown in the Dagster UI"
